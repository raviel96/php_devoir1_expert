...
class Database {
    ...
    public function getSportData(PDO $pdo){
    ...
    public function getStudentData(PDO $pdo) {
        try {
            $sql = "SELECT ";
        } catch (\PDOException $e) {
            die($e->getMessage());
    ...
    // creer 4eme table et relation entre sport et eleve. foreign key (eleve id ) pour table sport
}
